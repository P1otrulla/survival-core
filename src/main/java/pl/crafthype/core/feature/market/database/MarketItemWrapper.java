...
@DatabaseTable(tableName = "core_market_items")
public class MarketItemWrapper {
    ...
    public MarketItemWrapper(UUID itemId, ItemStack itemStack, double price, UUID uniqueId, String seller, Instant issuedAt) {
        this.itemId = itemId;
    ...
    public MarketItemWrapper() {
    }

    static MarketItemWrapper from(UUID itemId, ItemStack itemStack, double price, UUID uniqueId, String seller, Instant issuedAt) {
        return new MarketItemWrapper(itemId, itemStack, price, uniqueId, seller, issuedAt);
    }

    static MarketItemWrapper from(MarketItem marketItem) {
        return new MarketItemWrapper(marketItem.itemId(), marketItem.itemStack(), marketItem.price(), marketItem.uniqueId(), marketItem.seller(), marketItem.issuedAt());
    }
